...
function total_customize_register( $wp_customize ) {
	...
	<li>' . __( "One click demo import" , "total" ) . '</li>
	<li>' . __( "6 header layouts and advanced header settings" , "total" ) . '</li>
	<li>' . __( "In-built MegaMenu" , "total" ) . '</li>
	<li>' . __( "Unlimited slider with linkable button" , "total" ) . '</li>
	<li>' . __( "Add unlimited blocks(like slider, team, testimonial) for each Section" , "total" ) . '</li>
	<li>' . __( "Advanced Typography options" , "total" ) . '</li>
	<li>' . __( "Video background, Image Motion background, Parallax background, Gradient background option for each section" , "total" ) . '</li>
	<li>' . __( "Advanced color options" , "total" ) . '</li>
	<li>' . __( "Section reorder" , "total" ) . '</li>
	<li>' . __( "Top header bar" , "total" ) . '</li>
	<li>' . __( "16 Front page sections" , "total" ) . '</li>
	<li>' . __( "Fully customizable options for Front Page blocks" , "total" ) . '</li>
	<li>' . __( "PreLoader option" , "total" ) . '</li>
	<li>' . __( "Sidebar layout options" , "total" ) . '</li>
	<li>' . __( "Website layout (Fullwidth or Boxed)" , "total" ) . '</li>
	<li>' . __( "Advanced blog settings" , "total" ) . '</li>
	<li>' . __( "Advanced footer setting" , "total" ) . '</li>
	<li>' . __( "4 icon pack for icon picker (5000+ Icons)" , "total" ) . '</li>
	<li>' . __( "Remove footer credit Text" , "total" ) . '</li>
	<li>' . __( "Front page sections with full window height" , "total" ) . '</li>
	<li>' . __( "26 custom widgets" , "total" ) . '</li>
	<li>' . __( "Blog single page - Author Box, Social Share and Related Post" , "total" ) . '</li>
	<li>' . __( "Google map option" , "total" ) . '</li>
	<li>' . __( "WooCommerce Compatible" , "total" ) . '</li>
	<li>' . __( "Fully Multilingual and Translation ready" , "total" ) . '</li>
	</ul>
	<a class="ht-implink" href="https://hashthemes.com/wordpress-theme/total-plus/#theme-comparision-tab" target="_blank">' . __( "Check More Detail" , "total" ) . '</a>';


	$wp_customize->register_section_type( 'Total_Customize_Section_Pro' );
	// Register sections.
	$wp_customize->add_section(
		new Total_Customize_Section_Pro(
			$wp_customize,
			'total-pro-section',
			array(
				'priority' => 0,
	...
	/*============PRO FEATURES============*/
	$wp_customize->add_section(
		'total_pro_feature_section',
		array(
			'title' 			=> __( 'Pro Theme Features', 'total' ),
			'priority'			=> 1
		)
	);
	...
	$wp_customize->add_control(
		new Total_Info_Text( 
			...
			array(
				...
				'description'	=> '<a class="ht-implink" href="http://demo.hashthemes.com/total/" target="_blank">'.__('Live Demo', 'total').'</a><a class="ht-implink" href="https://hashthemes.com/support/" target="_blank">'.__('Support Forum', 'total').'</a><a class="ht-implink" href="https://www.facebook.com/hashtheme/" target="_blank">'.__('Like Us in Facebook', 'total').'</a>',
			)
		)
	);
